...
// keys gotten from TMDB
const TMDB_API_KEY = process.env.TMDB_API_KEY;      // put in server/.env
const SERPAPI_KEY  = process.env.SERPAPI_KEY;       // put in server/.env
...
// --- Get credits + do the “refined main cast” selection on server ---
app.get("/api/credits/:movieId", async (req,res) => {
  ...
  // Return both: preselected main + full sorted for editing
  res.json({
...
// --- Scrape images via SerpAPI image search (lightweight, careful with quotas) ---
